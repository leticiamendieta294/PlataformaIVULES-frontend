...
//public static apiUrlBackend: string = "https://nidtec.pol.una.py:55780/ivules/auth";
	...
	public static PROC_FINALIZADO : string = "FINALIZADO";
	public static PROC_PENDIENTE : string = "PENDIENTE";
	public static ENTREGADO : string = "ENT";
	public static NOENTREGADO : string = "NOENT";
