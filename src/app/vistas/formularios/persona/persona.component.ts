...
export class PersonaComponent implements OnInit {
  ...
  get codigoNoValido() {
    return this.personaForm.get('codigo').invalid && this.personaForm.get('codigo').touched
  }
  ...
  get edadNoValido() {
    return this.personaForm.get('edad').invalid && this.personaForm.get('edad').touched
  }

  get sexoNoValido() {
    return this.personaForm.get('sexo').invalid && this.personaForm.get('sexo').touched
  }
